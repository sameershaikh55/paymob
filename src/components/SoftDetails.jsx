	...
	const data = [
		{
			...
			d: "An daptable solution designed to fit your own branding style for both back end portals to customer facing interfaces. Powered by paymob, looks like you!",
		},
		{
			t: (
				<h5 className="fw600 text-white mb-4">
