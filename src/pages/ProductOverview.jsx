...
const ProductOverview = () => {
	return (
		<Layout>
					...
					<div className="container-fluid">
						<div className="row">
							<div className="d-flex flex-column align-items-center col-11 col-lg-12 mx-auto">
								...
								<div className="line my-3 me-2"></div>
								<p className="col-12 col-md-10 col-lg-8 gotham f20 lh39 text-white text-center mb-1">
								...
								<h6 className="text-white f14 lh39 fw-light gotham">
			...
			{/* PAGE TEXT END */}
			<div className="softPos_container py-4 mb-5">
				<div className="page_container">
					<div className="container-fluid">
						<div className="row">
							<div className="col-10 mx-auto">
								...
								<div className="d-flex justify-content-center mt-4">
									<button className="color1 border-0 bg-white py-2 fw500 f18 px-4">
